      ...
      <div className="p1">
        ...
        <div className="filters">
          ...
          <div className="dropdown1" ref={categoryDropdownRef}>
            ...
            <select value={category} onChange={e => setCategory(e.target.value)} className="hidden-select" aria-hidden="true" tabIndex="-1">
              {categories.map(option => (
          ...
          <div className="dropdown1" ref={priceDropdownRef}>
            ...
            <select value={priceFilter} onChange={e => setPriceFilter(e.target.value)} className="hidden-select" aria-hidden="true" tabIndex="-1">
              {priceFilters.map(option => (
                <option key={option.value} value={option.value}>{option.label}</option>
              ))}
            </select>
          ...
          <div className="dropdown1" ref={ratingDropdownRef}>
            ...
            <select value={ratingFilter} onChange={e => setRatingFilter(e.target.value)} className="hidden-select" aria-hidden="true" tabIndex="-1">
              {ratingFilters.map(option => (
                <option key={option.value} value={option.value}>{option.label}</option>
              ))}
            </select>
